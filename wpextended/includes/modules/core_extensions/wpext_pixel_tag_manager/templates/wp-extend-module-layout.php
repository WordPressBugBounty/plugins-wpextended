...
<div class="text-dark px-4 py-4 m-2 wpext_pixel_tag_manager">
   <form name="pixel" method="post" action="<?php echo esc_url( admin_url( 'options.php' ) ); ?>" class="wpext-pixel-tag" id="wp-extended-pixel-tag-manager-frm">
         ...
         <div class="row pt-3">
           <div class="mb-3">
             <div class="input-group"> <span class="input-group-text" id="wpxt-google-analitic"><img src="<?php echo plugin_dir_url( dirname( __FILE__ )  ) ?>img/wpext_analytics.png"></span>
               <input class="form-control" type="text" name="wpext-pixel-tag[wpxt-google-analitic]" placeholder="<?php _e('Google Analytics tracking ID',WP_EXTENDED_TEXT_DOMAIN); ?>" id="wpxt-google-analitic" value="<?php echo isset( $pixeldata['wpxt-google-analitic'] ) ? esc_attr( $pixeldata['wpxt-google-analitic'] ) : ''; ?>"> </div>
           ...
           <div class="mb-3">
             <div class="input-group"> <span class="input-group-text" id="wpxt-facebook-pixel"><img src="<?php echo plugin_dir_url( dirname( __FILE__ )  ) ?>img/wpext-fb.png"></span>
               <input class="form-control" type="text" name="wpext-pixel-tag[wpext-facebook]" placeholder="<?php _e('Facebook Pixel ID', WP_EXTENDED_TEXT_DOMAIN); ?>" id="wpxt-facebook-pixel" value="<?php echo isset( $pixeldata['wpext-facebook'] ) ? esc_attr( $pixeldata['wpext-facebook'] ) : ''; ?>"> </div>
           ...
           <div class="pb-3">
             <div class="input-group"> <span class="input-group-text" id="wpext-pintrest"><img width="20" src="<?php echo plugin_dir_url( dirname( __FILE__ )  ) ?>img/pintrest.png"></span>
               <input class="form-control" type="text" name="wpext-pixel-tag[wpext-pintrest]" placeholder="<?php _e('Pintrest Pixel ID',WP_EXTENDED_TEXT_DOMAIN); ?>" id="wpext-pintrest" value="<?php echo isset( $pixeldata['wpext-pintrest'] ) ? esc_attr( $pixeldata['wpext-pintrest'] ) : ''; ?>"> </div>
